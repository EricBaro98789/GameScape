...
// +++ NEW: Route for fetching details of a single game +++

app.get('/api/games/:id', async (req, res) => {

 const gameId = req.params.id; // Get the game ID from the route parameter

 const apiKey = '49019cbf03744419a483362b07d2f0a1'; // Or process.env.RAWG_API_KEY
 ...
 // The RAWG API endpoint for a specific game is usually /games/{id}
 ...
 res.json(response.data); // Send the detailed game data
